...
-- -----------------------------------------------------
-- Table `OnlineCourses`.`role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OnlineCourses`.`role` (
  `id_role` INT NOT NULL AUTO_INCREMENT,
  `is_admin` TINYINT NOT NULL,
  `is_formateur` TINYINT NOT NULL,
  `is_ban` TINYINT NOT NULL,
  UNIQUE INDEX `id_user_UNIQUE` (`id_role` ASC),
  CONSTRAINT `fk_role`
    FOREIGN KEY (`id_role`)
    REFERENCES `OnlineCourses`.`users` (`id`)
    ON DELETE NO ACTION
